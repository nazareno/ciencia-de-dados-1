...
Normalmente temos *uma amostra* da população apenas. Daí não conhecemos a distribuição amostral. Mas gostaríamos de a parti da nossa amostra estimar onde está uma estatística para a população. 
